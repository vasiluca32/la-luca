    ...
    <footer className='footer-component bg-light pt-3 pb-3'>
      <div className='container-fluid text-left'>
        <div className='row justify-content-between'>
          <div className='col-md-4 mb-3 mb-5 mb-md-0'>
          ...
          <div className='col-sm-4 col-md-4 d-flex justify-content-evenly justify-content-sm-center justify-content-md-evenly mb-5 mb-sm-0'>
          ...
          <div className='col-sm-8 col-md-4 social-icons mb-5 mb-sm-0'>
            <h3 className='mb-4 text-center'>Follow us on social media</h3>
